...
const si: typeof en = {
  ...
  hero: {
    ...
    titleLine1: 'සරල බව තුළ ඇති',
    titleLine2: 'සැබෑ අලංකාරය',
    body: 'අපි විලාසිතාවක් පසුපස දුවන්නේ නැහැ. හොඳ රෙදි, හොඳ නිමාව සහ දිගුකාලීන භාවිතය ගැන අපි සැලකිලිමත් වෙනවා. ලොම්, කෂ්මීර් සහ හණ වැනි ස්වභාවික තන්තු වලින් නිමවූ, ප්‍රමාණයෙන් සීමිත සහ ඉතා සැලකිල්ලෙන් නිෂ්පාදනය කළ ඇඳුම් එකතුවක්.',
  ...
  marquee: [
    ...
    'නව එකතුව දැන් නිකුත් කර ඇත',
    'ස්වභාවික තන්තු පමණි',
    'සීමිත නිෂ්පාදන ප්‍රමාණ',
    'දින 30ක් ඇතුළත ආපසු භාරදීම',
    'පරිසර හිතකාමී බෙදාහැරීම',
  ],
  newArrivals: {
    eyebrow: '01 — තෝරාගත් නිමැවුම්',
    titlePlain: 'අලුතින් පැමිණි',
    titleItalic: 'නිමැවුම්',
    body: 'මෙම සමය සඳහා තෝරාගත් අත්‍යවශ්‍ය ඇඳුම් කිහිපයක්. කෙටි කාලීන විලාසිතාවන්ට වඩා, දිගු කලක් අඳින්නට හැකි ගුණාත්මකභාවයට අපි මුල්තැන දෙමු.',
  ...
  products: {
    ...
    knit: {
      ...
      detail: 'මොංගෝලියානු කෂ්මීර් · ඩූන් පැහැය',
  ...
  collections: {
    ...
    women: { name: 'කාන්තා එකතුව', note: 'කබා, නිට් ඇඳුම් සහ මැහුම් නිමැවුම්' },
    men: { name: 'පිරිමි එකතුව', note: 'කමිස, පිටත ඇඳුම් සහ ඩෙනිම්' },
  },
  story: {
    eyebrow: '03 — නිර්මාණාගාරය',
    titleLine1: 'අදට පමණක් නොව,',
    titleItalic: 'හෙටටත් ගැළපෙන ඇඳුම්',
    para1:
      'Noir Atelier ආරම්භ වූයේ එක් සරල අදහසකිනි — හොඳ ඇඳුමක් කෙටි කාලයකට පමණක් නොව, වසර ගණනාවක් පුරා ඔබ සමඟ සිටිය යුතුය. ඒ නිසා අපි ඉක්මනින් වෙනස් වන විලාසිතාවන් පසුපස නොයමු. ඒ වෙනුවට, හොඳ රෙදි, නිවැරදි නිමාව සහ කල් පවතින මෝස්තර තෝරා ගනිමු. පෘතුගාලයේ සහ ඉතාලියේ පවුල් සතු නිර්මාණාගාර සමඟ සෘජුව වැඩ කරමින්, ලොම්, කෂ්මීර් සහ හණ වැනි ස්වභාවික තන්තු වලින් අපේ ඇඳුම් නිමවෙයි.',
    para2:
      'සෑම ඇඳුමකම එය නිම කළ ශිල්පියාගේ මුලකුරු සටහන් කර ඇත. මන්ද, සැබෑ ගුණාත්මකභාවය යන්ත්‍රයකින් පමණක් නිර්මාණය කළ නොහැකි බැවිනි. එය මිනිස් අත්දැකීම, කාලය සහ සැලකිල්ල සමඟ නිමවෙයි.',
    estSince: '2019 සිට',
    places: 'ලිස්බන් · පෝර්ටෝ · ෆ්ලොරන්ස්',
    stats: [
      { value: '100%', label: 'ස්වභාවික තන්තු' },
      { value: '12', label: 'හවුල් නිර්මාණාගාර' },
      { value: '0', label: 'අනවශ්‍ය ලාංඡන' },
      { value: '10 වසර', label: 'අලුත්වැඩියා සහතිකය' },
    ],
  },
  testimonials: {
    eyebrow: '04 — පාරිභෝගික අත්දැකීම්',
    titlePlain: 'අඳින අයගේ',
    titleItalic: 'වචන',
  ...
  newsletter: {
    ...
    titleItalic: 'අනවශ්‍ය පණිවිඩ නැහැ',
    body: 'සතියකට එක් ලිපියක් පමණයි — නව නිමැවුම්, නිර්මාණාගාරයේ කතා සහ නව එකතු සැමට විවෘත කිරීමට පෙර ඔබට ලැබෙන විශේෂ ප්‍රවේශය. කැමති ඕනෑම අවස්ථාවක ඉවත් විය හැකියි.',
  ...
  footer: {
    brand: 'Noir Atelier',
    blurb:
      'ස්වභාවික තන්තුවලින් නිමවූ, ප්‍රවේශමෙන් තෝරාගත් ඇඳුම්. ලිස්බනයේ සැලසුම් කර, පෘතුගාලයේ සහ ඉතාලියේ නිර්මාණාගාරවල නිෂ්පාදනය කරනු ලැබේ.',
    cols: [
      { title: 'සාප්පුව', links: ['නව පැමිණීම්', 'කාන්තා', 'පිරිමි', 'තෑගි කාඩ්පත්', 'අවසන් අවස්ථා'] },
      { title: 'සමාගම', links: ['අපේ නිර්මාණාගාර', 'සඟරාව', 'රැකියා', 'අලෙවිසැල්'] },
